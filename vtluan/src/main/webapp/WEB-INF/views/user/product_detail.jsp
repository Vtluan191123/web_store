                            ...
                            <div class="col-lg-8 col-xl-9">
                                <div class="row g-4">
                                        ...
                                        <div class="border rounded">
                                            <a href="#">
                                                <img style="height: 300px; width: 100%;"
                                                    src="client/image/${product.image}" class="img-fluid rounded"
                                                    alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <p class="mb-3">Brand: ${product.brand}</p>
                                        <h5<p class="text-dark fs-5 fw-bold mb-0">
                                            <span
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="tab-content mb-5">
                                            ...
                                            <div class="tab-pane" id="nav-mission" role="tabpanel"
                                                ...
                                                <div class="d-flex">
                                                    <img src="client/image/avatar.jpg"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>Microsoft</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
