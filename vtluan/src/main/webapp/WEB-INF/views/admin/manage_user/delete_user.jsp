                    ...
                    <div class="content">
                        ...
                        <div class="container col-12">
                            <div class="alert alert-danger" role="alert">
                                are you sure delete it with id = ${user.id};
                            </div>
                            <form:form action="/admin/user/deleted" method="post" modelAttribute="user">
                                <form:input style="display: none;" type="text" path="id" />
