                    ...
                    <div class="content">
                        ...
                        <div class="container col-10 mt-5">
                            <div class="bg-white p-4 rounded shadow">
                                <h1 class="mb-2">Update Product</h1>
                                <form:form method="post" action="/admin/product/edited" modelAttribute="products"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="mb-3 d-none">
                                                <label for="des_short" class="form-label ">ImageName</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <img id="imagePreview" src="/admin/image/${products.image}"
                                                alt="Image Preview" />
                                        </div>
                                    </div>
