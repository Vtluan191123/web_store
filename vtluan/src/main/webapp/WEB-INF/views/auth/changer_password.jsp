                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                                <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <h3 style="width: 124px;">Changer Password</h3>
                                    </div>

                                    <form method="post" action="/changer_password">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="floatingInput"
                                                placeholder="name@example.com" name="confirm">
                                            <label for="floatingInput">Confirm Password</label>
                                        </div>
                                        <div class="form-floating mb-3 d-none">
                                            <input type="text" class="form-control" id="floatingInput" value="${token}"
                                                name="token">
                                        ...
                                        <c:if test="${message!=null}">
                                            <p style="color: rgb(216, 20, 20);font-size: 18px;">${message}</p>
                                        </c:if>
